...
/**
 * RIL customization for Galaxy Grand2 (GSM) LTE devices
 *
 * {@hide}
 */
public class ms013gRIL extends RIL {

    private static final int RIL_REQUEST_DIAL_EMERGENCY = 10016;

    public ms013gRIL(Context context, int networkMode, int cdmaSubscription) {
